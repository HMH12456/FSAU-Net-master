...
# from model.unetpulsplus import unetplusplus
# from model.SegNet import SegNet
# from model.cabpspnet import cabpspnet
# from model.resnet101SE import resnet101SE
...
pred = FCN(img, is_training=False)
